...
<template>
  <div class="w-full relative md:min-w-60 md:w-auto">
    <div class="px-4 py-2.5 rounded-lg bg-white/10 flex gap-2.5 w-full items-center justify-between">
      <input
        v-model="searchQuery" type="text" :placeholder="selectedCityName"
